  ...
  Selectpicker.prototype = {
    ...
    render: function(updateLi) {
      ...
      var notDisabled = this.options.hideDisabled ? ':enabled' : '',
          ...
          var selectedIcon = this.$element.find('option:selected' + notDisabled).map(function() {
			  return $(this).attr("data-thumbnail");
          }).toArray();
	  ...
	  var test = '<img src="'+selectedIcon[0]+'" class="media-object" style="width:20px;display:inline;margin-right:10px">';
	  title = (!this.multiple || this.options.selectedTextFormat==='values') ? title : this.options.title;

      this.$button.children('.filter-option').html(test+title);

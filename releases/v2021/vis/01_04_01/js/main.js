...
$(document).ready(function() {
	...
	$("#infographTitle").html(_('document.title'));
	$("#scaleWrapper,#container").css("width",chartWidth);
	$("#scaleWrapper,#container").css("height",chartHeight);
	...
	$("#femaleBtnLabel").html( _('indiBtnTooltip_0') );
	$("#maleBtnLabel").html( _('indiBtnTooltip_1') );
	
	//$(".data-footnote").html(_("noDataFootnote"));
	...
	$(".data-bookmark").html(datasetLink);
	...
	if (simple) $("#container").css("margin-top", "4%");
...
BubbleChart = (function() {
    ...
    BubbleChart.prototype.initThema = function(chart) {
            ...
            $(".themaIcon").click(function() {
				...
				$(".themaIcon").css("background-color", "white");
				...
				var gender  = elemKey == "value_1" ? "FeMale" : "Male";
				...
				$("#indicatorUnit").html("<span style='font-size:14px;'>" + _('mainSubtitle') + "</span>");
				$("#indicatorUnit").css({"display":"inline", "font-size":"12px", "margin-left":"0px"});
		...
		var popoverContent = "<ul id=\"shareConteiner\">" +
			"<li style='position:relative;display:inlne;'><span class='tooltip-btm'>" + _('infoLabel') + "</span><a class=\"info\" href=\"#\"><i class=\"fa fa-info share-btn\"></i></a></li>";
		...
		if (parentLocation.hostname.indexOf('ec.europa.eu') == -1 || (parentLocation.hostname.indexOf('ec.europa.eu') > -1 && !isEmbed) ){
			
			if (!simple){
			
				popoverContent += "<li style='position:relative;display:inlne;'><span class='tooltip-btm'>" + _('linkToDataset') + "</span><a class=\"dataset\" href=\"#\"><i class=\"fa fa-table share-btn\"></i></a></li>";
		...
		$("#shareConteiner .dataset").click(function() {
			
			var popupContent = "";
			var popupTitle   = _('linkToDataset');
			
			popupContent += '<a href="' + chartDatasetLink + '&lang=' + langUsed + '" target=\"_blank\">';
			popupContent += _('mainTitle');
			popupContent += "</a>";
		...
		$("#shareConteiner .facebook").click(function() {
			...
			if (chart.isTablet == false) {
				...
				window.location.href = "facebook:" + "entrypoints/" + this.indCode + "_" + currentLang + ".html?redirect=facebook";
    ...
    BubbleChart.prototype.create_nodes = function(elemKey) {
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
        ...
        var value  = this.roundValue(obj.ilc_pw01).toFixed(1);
		var gender = (obj.gender == "Male") ? _('genderMale') : _('genderFemale');
		var cntryCode  = data.countryCode.toUpperCase();
		var labelStyle = "style='margin-top: 2px;marginBottom:2px;'";
		
		cntryCode = (cntryCode === "EU27_2020") ? "EU" : cntryCode;
		
		value = getDecimalSeparator(value);

        content = "<div style=\"height:20px\"><span class=\"name\">" + _('bubbleTooltipLabel1') + ": </span><span class=\"value\" style=\"font-weight:bold\"> " + _(cntryCode) + "</div>";
        content += "<span class=\"name\"" + labelStyle + ">" + _('bubbleTooltipLabel2') + ": </span><span class=\"value\"> " + gender + " "+unit+"</span><br/>";
		content += "<span class=\"name\"" + labelStyle + ">" + _('bubbleTooltipLabel3') + ": </span><span class=\"value\"> " + value + " "+unit+"</span>";
